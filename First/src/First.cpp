...
// A Utility Function to check whether a given cell (row, col) is a valid cell or not.
...
void aStarSearch(int grid[][COL], Pair src, Pair dest)
{
    ...
    // Create a closed list and initialise it to false i.e that no cell has been included yet
       ...
       /*
        ...
        if (isValid(i-1, j) == true)
        {
            ...
            if (isDestination(i-1, j, dest) == true)
            {
                ...
                printf ("We have found the destination:\n");
